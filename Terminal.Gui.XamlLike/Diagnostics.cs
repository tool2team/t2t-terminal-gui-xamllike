...
public static class TuiDiagnostics
{
    ...
    public static readonly DiagnosticDescriptor UnknownControlType = new(
        ...
        messageFormat: "Unknown control type '{0}'. See Terminal.Gui documentation for supported View types.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "The specified control type is not supported by Terminal.Gui or this generator. Refer to Terminal.Gui documentation for available View types.",
        helpLinkUri: "https://gui-cs.github.io/Terminal.Gui/");
